...
DATA_PATH = os.path.join(ROOT_DIR, 'data','s3dis', 'Stanford3dDataset_v1.2') #_Aligned_Version')

#g_classes = ['cylinder','box','bin'] 
g_classes = ['cylinder','box','floor', 'back', 'side', 'ceiling'] 
g_class2label = {cls: i for i,cls in enumerate(g_classes)}

g_class2color = {'cylinder': [0,255,0], #green
                 'box' :	[255,0,0],  #red
                 'floor':	[255,255,255], #white/grey
                 'back':        [0,0,0], #black
                 'side':      [148,0,211], #purple
                 'ceiling':      [255,147,23], #orange
                 'door':        [200,200,100],
                 'table':       [170,120,200],
                 'chair':       [255,0,0],
                 'sofa':        [200,100,100],
